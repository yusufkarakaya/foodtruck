  ...
  return (
    <div className="flex justify-center max-w-[1200px] mx-auto">
      <div className="bg-[#2C3E50] text-white p-8 shadow-md w-full">
        <h2 className="text-5xl font-bold text-center mb-8">Truck Schedule</h2>
          ...
          <div className="w-1/2">
            ...
            <ul className="space-y-6">
              <li className="flex justify-start gap-16">
                <span className="text-xl">09:00 - 11:00</span>
                <div>
              ...
              <li className="flex justify-start gap-16">
                <span className="text-xl">11:30 - 15:00</span>
                <div>
                  <span className="font-semibold text-yellow-400 text-xl">
                    Woodland Hills
                  </span>
              ...
              <li className="flex justify-start gap-16">
                <span className="text-xl">15:30 - 18:00</span>
                <div>
                  <span className="font-semibold text-yellow-400 text-xl">
                    Granada Hills
                  </span>
